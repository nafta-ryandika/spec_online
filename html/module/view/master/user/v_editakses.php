            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" disabled id="KODE_USER" name="KODE_USER" value="<?php echo $KODE_USER; ?>" data-parsley-required>
                    </div>                           
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="NAMA_USER">Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" disabled id="NAMA_USER" name="NAMA_USER" value="<?php echo $NAMA_USER; ?>" data-parsley-required>
                    </div>                           
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select disabled name="KODE_PERUSAHAAN" id="KODE_PERUSAHAAN" class="form-control" data-parsley-required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" disabled id="DEPARTEMEN" name="DEPARTEMEN" value="<?php echo $DEPARTEMEN; ?>" data-parsley-required>
                    </div>                           
                </div>
            </div>
            <div class="row">
